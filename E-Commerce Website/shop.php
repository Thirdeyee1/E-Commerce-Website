...
<!--Bolts-->
<section id="bolts" class="my-5 py-5">
    <div class ="mt-5 py-5 " style="padding-left:30px;">
        <h3>Bolts</h3>
        <hr>
...
<!--Nuts-->
<section id="nuts" class="my-5 py-5">
    <div class ="mt-5 py-5"style="padding-left:30px;">
        <h3>Nuts</h3>
        <hr>
    ...
    <?php while($row=$nuts_products->fetch_assoc()){?>
...
<!--Screws-->
<section id="screws" class="my-5 py-5">
    <div class ="mt-5 mb-5 py-5"style="padding-left:30px;">
        <h3>Screws</h3>
        <hr>
    ...
    <?php include('server/get_screws.php');?>
    <?php while($row=$screws_products->fetch_assoc()){?>
